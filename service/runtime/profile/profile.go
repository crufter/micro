...
func Platform() []string {
	return []string{
		...
		"MICRO_AUTH_ADDRESS=micro-auth.platform.svc:8010",
		"MICRO_BROKER_ADDRESS=micro-store.platform.svc:8001",
		"MICRO_NETWORK_ADDRESS=micro-network.platform.svc:8080",
		"MICRO_REGISTRY_ADDRESS=micro-registry.platform.svc:8000",
		"MICRO_ROUTER_ADDRESS=micro-runtime.platform.svc:8084",
		"MICRO_RUNTIME_ADDRESS=micro-runtime.platform.svc:8088",
		"MICRO_STORE_ADDRESS=micro-store.platform.svc:8002",
